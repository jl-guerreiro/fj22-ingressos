...
public class GerenciadorSessaoTest {
	...
	public void garanteQueNaoDevePermitirSessaoNoMesmoHorario(){
		Filme f = new Filme("Rogue One", Duration.ofMinutes(120), "Açao");
	...
	public void garanteQueDevePermitirUmaInsercaoEntreDoisFilmes(){
		Sala sa = new Sala("");
		Filme f1 = new Filme("Rogue One", Duration.ofMinutes(90), "Ação");
		LocalTime dez = LocalTime.parse("10:00:00");
		Sessao se10 = new Sessao(sa,f1,dez);
		Filme f2 = new Filme("Rogue One", Duration.ofMinutes(120), "Ação");
		LocalTime seis = LocalTime.parse("18:00:00");
		Sessao se18 = new Sessao(sa,f2,seis);
		List<Sessao> ls = Arrays.asList(se10,se18);
		GerenciadorSessao gs = new GerenciadorSessao(ls);
		Sessao se = new Sessao(sa,new Filme("A",Duration.ofMinutes(90),"A"),LocalTime.parse("13:00:00"));
